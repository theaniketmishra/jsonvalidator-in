...
import { SecretScannerWorkspace } from "@/features/json-secret-scanner/secret-scanner-workspace";
...
const tool = toolBySlug("json-secret-scanner")!;
    ...
    <>
      ...
      <ToolPageShell tool={tool}>
        <ProGate requiredPlan={tool.proTier ?? "starter"} featureName={tool.name}>
          <SecretScannerWorkspace sample={tool.sampleInput} />
        </ProGate>
      </ToolPageShell>
    </>
  );
