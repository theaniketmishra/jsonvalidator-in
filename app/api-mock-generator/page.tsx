...
import { MockGeneratorWorkspace } from "@/features/json-mock-generator/mock-generator-page-workspace";
...
const tool = toolBySlug("api-mock-generator")!;
  ...
  return (
    <>
      ...
      <ToolPageShell tool={tool}>
        <MockGeneratorWorkspace sample={tool.sampleInput} />
      </ToolPageShell>
    </>
  );
}
