...
import { TreeViewWorkspace } from "@/features/json-tree-view/tree-view-workspace";
...
const tool = toolBySlug("json-tree-view")!;
  ...
  return (
    <>
      ...
      <ToolPageShell tool={tool}>
        <TreeViewWorkspace sample={tool.sampleInput} />
      </ToolPageShell>
    </>
  );
}
