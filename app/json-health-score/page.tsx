...
import { HealthScoreWorkspace } from "@/features/json-health-score/health-score-workspace";
...
const tool = toolBySlug("json-health-score")!;
    ...
    <>
      ...
      <ToolPageShell tool={tool}>
        <ProGate requiredPlan={tool.proTier ?? "starter"} featureName={tool.name}>
          <HealthScoreWorkspace sample={tool.sampleInput} />
        </ProGate>
      </ToolPageShell>
    </>
  );
