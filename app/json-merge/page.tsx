...
import { MergeWorkspace } from "@/features/json-merge/merge-workspace";
...
const tool = toolBySlug("json-merge")!;
  ...
  return (
    <>
      ...
      <ToolPageShell tool={tool}>
        <MergeWorkspace sampleA={tool.sampleInput} sampleB={"{\"isActive\":false,\"address\":{\"city\":\"Mumbai\"}}"} />
      </ToolPageShell>
    </>
  );
}
