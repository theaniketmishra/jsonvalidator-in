...
import { OptimizerWorkspace } from "@/features/json-payload-optimizer/optimizer-workspace";
...
const tool = toolBySlug("json-payload-optimizer")!;
  ...
  return (
    <>
      ...
      <ToolPageShell tool={tool}>
        <ProGate tool={tool}>
          <OptimizerWorkspace sample={tool.sampleInput} />
        </ProGate>
      </ToolPageShell>
    </>
  );
