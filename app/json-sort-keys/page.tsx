...
import { SortKeysWorkspace } from "@/features/json-sort-keys/sort-keys-workspace";
...
const tool = toolBySlug("json-sort-keys")!;
  ...
  return (
    <>
      ...
      <ToolPageShell tool={tool}>
        <SortKeysWorkspace sample={tool.sampleInput} />
      </ToolPageShell>
    </>
  );
}
