...
import { SanitizerWorkspace } from "@/features/json-sanitizer/sanitizer-workspace";
...
const tool = toolBySlug("json-sanitizer")!;
  ...
  return (
    <>
      ...
      <ToolPageShell tool={tool}>
        <ProGate tool={tool}>
          <SanitizerWorkspace sample={tool.sampleInput} />
        </ProGate>
      </ToolPageShell>
    </>
  );
