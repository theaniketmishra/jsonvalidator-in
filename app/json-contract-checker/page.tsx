...
import { ContractCheckerWorkspace } from "@/features/json-contract-checker/contract-checker-workspace";
...
const tool = toolBySlug("json-contract-checker")!;
  ...
  return (
    <>
      ...
      <ToolPageShell tool={tool}>
        <ContractCheckerWorkspace sampleA={tool.sampleInput} sampleB={"{\n  \"id\": 1024,\n  \"name\": \"Asha Verma\",\n  \"isActive\": false,\n  \"roles\": [\"admin\"],\n  \"address\": { \"city\": \"Mumbai\", \"pincode\": \"400001\" }\n}"} />
      </ToolPageShell>
    </>
  );
}
