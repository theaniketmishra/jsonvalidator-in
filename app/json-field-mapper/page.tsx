...
import { FieldMapperWorkspace } from "@/features/json-field-mapper/field-mapper-workspace";
...
const tool = toolBySlug("json-field-mapper")!;
  ...
  return (
    <>
      ...
      <ToolPageShell tool={tool}>
        <FieldMapperWorkspace sampleA={tool.sampleInput} sampleB={"{ \"id\": \"userId\", \"name\": \"fullName\" }"} />
      </ToolPageShell>
    </>
  );
}
